...
namespace BaiThucHanh0703.Controllers
{
    public class PersonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonID,PersonName,PersonPhone")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PersonID,PersonName,PersonPhone")] Person person)
        {
